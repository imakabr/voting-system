...
public class ItemTestData {
    ...
    public static final Item ITEM1 = new Item(START_ITEM_ID, TOKYO_CITY, "beer", 150, LocalDate.of(2019, 9, 20));
    public static final Item ITEM2 = new Item(START_ITEM_ID+1, TOKYO_CITY, "wok", 200, LocalDate.of(2019, 9, 20));
    public static final Item ITEM3 = new Item(START_ITEM_ID+2, KETCH_UP, "beer", 300, LocalDate.of(2019, 9, 20));
    public static final Item ITEM4 = new Item(START_ITEM_ID+3, TOKYO_CITY, "beer", 150, LocalDate.of(2019, 9, 21));
    public static final Item ITEM5 = new Item(START_ITEM_ID+4, KETCH_UP, "salad", 200, LocalDate.of(2019, 9, 21));
...
//    );
    ...
    public static final List<Item> ITEMS_FOR_TOKYO_ALL = List.of(
            new Item(START_ITEM_ID+3, TOKYO_CITY, "beer", 150, LocalDate.of(2019, 9, 21)), //9
            new Item(START_ITEM_ID, TOKYO_CITY, "beer", 150, LocalDate.of(2019, 9, 20)), //6
            new Item(START_ITEM_ID+1, TOKYO_CITY, "wok", 200, LocalDate.of(2019, 9, 20))  //7
    );
    ...
    public static final List<Item> ITEMS_FOR_KETCHUP_20_09 = List.of(
            new Item(START_ITEM_ID+2, KETCH_UP, "beer", 300, LocalDate.of(2019, 9, 20))  //8
    );
